...
| 1.菜单id | | |
| 2.父级菜单id | | |
| [3.前端资源代码](/sdp/build_by_excel/4-sheet_menu.html#参数3前端资源代码) <Badge text="2024-11-26" type="tip" /> | | |
| 4.菜单名称 | | |
| [5.菜单路径](/sdp/build_by_excel/4-sheet_menu.html#参数5菜单路径--参数10组件) | | 浏览器展现路径 |
| 6.高亮节点路径 | | 打开隐藏菜单页面时，菜单所处的高亮节点 |
| 7.菜单图标 | | |
| 8.隐藏 | `0` \| `1` | 菜单是否隐藏 |
| 9.路径重定向 | | |
| [10.组件](/sdp/build_by_excel/4-sheet_menu.html#参数5菜单路径--参数10组件) | | |
| 11.有效标记 | `0` \| `1` | |
| 12.默认全屏 | `0` \| `1` | 开启后，仅显示引用组件，不显示页头，菜单 |
| 13.菜单类型 | `1` \| `9` | 1-菜单，9-按钮 |
| 14.菜单序列 | | |
| 15.角色 | | 当前菜单的可用角色 |
