...
- 开发环境：nodejs、包管理工具
- 项目搭建：下载代码 → 装依赖 → 启动 → 初始化 → 登录
- 第一个模块：Excel → 系统构建
- 发布到生产环境

**不讲什么**(看其他页)：

- 6 类基础模块(m1-m6)怎么配 → [我能做什么 - 基础模块](/sdp/what_can_do/what_can_do_01.html)
- 平台菜单全景 → [菜单全景](/sdp/what_can_do/what_can_do_03.html)
- 11 类高阶能力 → [高级能力](/sdp/instruction.html)
